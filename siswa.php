            ...
            <main class="col-md-10 ms-sm-auto px-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div class="d-flex gap-2">
                        <a href="edit/tambah_siswa.php" class="btn btn-primary">+ Tambah Siswa</a>
                        <a href="restore/restore_siswa.php" class="btn btn-success">Restore</a>
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr>
                                        ...
                                        <td>{$row['alamat']}</td>
                                        <td>
                                            <a href='edit/edit_siswa.php?id={$row['id_siswa']}' class='btn btn-warning btn-sm'>Edit</a>
                                            <a href='edit/hapus_siswa.php?id={$row['id_siswa']}' class='btn btn-danger btn-sm' onclick='return confirm(\"Anda yakin ingin menghapus data ini?\")'>Hapus</a>
                                        </td>
                                    </tr>";
                                $no++;
                            }
